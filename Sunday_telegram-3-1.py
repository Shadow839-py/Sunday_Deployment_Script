...
# schedule_followup tool) to check back in later, and - if you go quiet
# past the due time - sends ONE natural, contextual check-in. If you
# message again before then (about anything), the pending check-in is
# cancelled.
#
